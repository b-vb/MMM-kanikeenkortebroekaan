...
module.exports = NodeHelper.create({
  start: function () {
    this.answer = { text: "null", imageSrc: null };
  },
      ...
      case "UPDATE_PLEASE":
        axios
          ...
          .then(({ data }) => {
            ...
            this.answer.imageSrc = `https://www.kanikeenkortebroekaan.nl/assets/${
              this.answer.text === "ja" ? "yes" : "no"
            }-man.png`;
            console.log("Kan ik een korte broek aan vandaag? ", this.answer);
            this.sendSocketNotification("ANSWER", this.answer);
          })
          .catch((error) =>
            console.log("Error while fetching kanikeenkortebroekaan.nl", error)
          );
        break;
    }
  }
